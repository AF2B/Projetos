...
export default function Form(props: FormProps) {
    ...
    return (
        <div>
            {id ? (
                <Input text="ID" value={id} justRead className="mb-4" />
            ) : false}

            <Input text="name" value={name} valueChange={setName} className="mb-4" />
            <Input text="age" value={age} type="number" valueChange={setAge} />
